...
public class CourseManager {
  ...
  public void addCourse() {
    ...
    while(totalVacancy <= 0) {
      System.out.println(" Vacancy cannot be less than or equal to zero. try again" );
    ...
    if(type != "LEC"){
      ...
      while(true) {
        ...
        if(groupName == "-1") break;
        System.out.print("Enter the group vacancy (in the end all the group vacancies must be equal to the total vacancy)" + totalVacancy );
      ...
      System.out.println("Format weightagename,percentage,true (if have child else false), \"\" (if no parent else \"nameOfParent\")"); //TODO BEAUTIFY
      System.out.println("Example: ");
      System.out.println("Exam,60%,false,\"\" <----- false, because it has no subcoursework. and \"\" because it has no parent");
      System.out.println("Coursework,40%,true,\"\" <----- true, because coursework is divided into more subcategories");
      System.out.println("Assignment,70%,false,Coursework <-------, Coursework because its parent is Coursework" );
