...
public class ScrameApp {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("WELCOME TO SCRAME !, please login, input \"admin\" for admin mode, or please input your student matric ");// beautify
    ...
    switch (choice) {
      ...
      case 2: // 4. Check available slot in a class (vacancy in a class)
      ...
      case 10: // 9. Print course statistics 
